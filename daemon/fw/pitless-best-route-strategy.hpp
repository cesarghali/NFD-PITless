...
#ifndef NFD_DAEMON_FW_PITLESS_BEST_ROUTE_STRATEGY_HPP
#define NFD_DAEMON_FW_PITLESS_BEST_ROUTE_STRATEGY_HPP
 ...
 *  PITless model.
 */
class PITlessBestRouteStrategy : public PITlessStrategy
{
public:
  PITlessBestRouteStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);

  virtual
  ~PITlessBestRouteStrategy();
