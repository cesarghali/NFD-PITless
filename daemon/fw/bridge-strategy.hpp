...
#ifndef NFD_DAEMON_FW_PITLESS_BRIDGE_STRATEGY_HPP
#define NFD_DAEMON_FW_PITLESS_BRIDGE_STRATEGY_HPP
...
public:
   ...
   */
  BridgeStrategy(Forwarder& forwarder, const Name& name);
...
public: // triggers
   ...
   */
  virtual void
  afterReceiveInterestBridge(const Face& inFace,
...
protected: // actions
  ...
  sendInterestBridge(const Interest& interest,
                      shared_ptr<Face> outFace,
                      bool wantNewNonce = false);
};

inline void
BridgeStrategy::sendInterestBridge(const Interest& interest,
                                              shared_ptr<Face> outFace,
                                              bool wantNewNonce)
{
  dynamic_cast<nfd::BridgeForwarder&>(getForwarder()).onOutgoingInterestBridge(interest, *outFace, wantNewNonce);
}

} // namespace fw
} // namespace nfd

#endif // NFD_DAEMON_FW_PITLESS_BRIDGE_STRATEGY_HPP
